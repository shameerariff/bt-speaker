...
apt-get update
apt-get --yes --force-yes install git bluez python3 python-gobject python3-gi python3-cffi python3-dbus python3-alsaaudio python-configparser sound-theme-freedesktop vorbis-tools
echo "done."
